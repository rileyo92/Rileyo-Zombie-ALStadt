...
country = {
	...
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 0.33, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
...
diplomacy = {
	...
	BREAKTRUCE_INFAMY_ADD_TO_SPHERE = 2.5,
	BREAKTRUCE_INFAMY_RELEASE_PUPPET = 2.5,
	BREAKTRUCE_INFAMY_MAKE_PUPPET = 2.5,
	BREAKTRUCE_INFAMY_DISARMAMENT = 2.5,
	BREAKTRUCE_INFAMY_DESTROY_FORTS = 2.5,
	BREAKTRUCE_INFAMY_DESTROY_NAVAL_BASES = 2.5,
	BREAKTRUCE_INFAMY_REPARATIONS = 2.5,
	BREAKTRUCE_INFAMY_TRANSFER_PROVINCES = 2.5,
	BREAKTRUCE_INFAMY_REMOVE_CORES = 0,
	BREAKTRUCE_INFAMY_PRESTIGE = 2.5,
	BREAKTRUCE_INFAMY_CONCEDE = 2.5,
	BREAKTRUCE_INFAMY_STATUS_QUO = 2.5,
	BREAKTRUCE_INFAMY_ANNEX = 2.5,
	BREAKTRUCE_INFAMY_DEMAND_STATE = 2.5,
	BREAKTRUCE_INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 2.5,
	BREAKTRUCE_INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 2.5,
	BREAKTRUCE_INFAMY_COLONY = 2.5,
